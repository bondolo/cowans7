...
public class CopyOnWriteArrayNavigableSet<E> extends AbstractSet<E>
    ...
    public CopyOnWriteArrayNavigableSet() {
        this((Comparator<? super E>) naturalOrder());
    }
   ...
   /**
    ...
    public CopyOnWriteArrayNavigableSet(Comparator<? super E> comparator) {
        this(comparator, new CopyOnWriteArrayList<E>());
    }
    ...
    public CopyOnWriteArrayNavigableSet(Iterable<? extends E> c) {
        if (c.getClass() == CopyOnWriteArrayNavigableSet.class) {
            ...
            this.comparator = (Comparator<? super E>) naturalOrder();
            this.al = new CopyOnWriteArrayList<>();
    ...
    private static class BoundedNavigableSet<E> extends CopyOnWriteArrayNavigableSet<E> {
        ...
        private int fromLoc(E[] array) {
            int start;
            if(lowerBounded) {
                start = Arrays.binarySearch(array, lowerBound, (Comparator<E>) (descending ?  reverseOrder(comparator) : comparator));
                start = start >= 0
        ...
        private int toLoc(E[] array) {
            int end;
            if(upperBounded) {
                end = Arrays.binarySearch(array, upperBound, (Comparator) (descending ? reverseOrder(comparator) : comparator));
                end = end >= 0
    ...
    private static <T extends Comparable<? super T>> Comparator<T> naturalOrder() {
        return (Comparator<T>) naturalOrderComparator;
    }

    private static <T> Comparator<? super T> reverseOrder(final Comparator<? super T> comparator) {
    ...
    private static final Comparator<Comparable<Object>> naturalOrderComparator = new Comparator<Comparable<Object>>() {
        @Override
